    ...
    <div class="container">
        <div class="corpo">
            <table class="table cols-12" border="2">
                ...
                <tr>
                    <td>
                        <h3> <?php echo $aux['TITULO'] ?></h3><br />Autor: <?php echo $aux['AUTOR'] ?>
                        <br />Edição: <?php echo $aux['EDICAO'] ?><br />Ano: <?php echo date('Y', strtotime($aux['ANO'])) ?>
                        <br /><a href=" <?php echo $aux['LINK'] ?>" target="blank">Baixar</a><br />
                    </td>
                </tr>
                <?php } while ($aux = mysqli_fetch_assoc($resultado)); ?> </table>
        </div>
    </div>
